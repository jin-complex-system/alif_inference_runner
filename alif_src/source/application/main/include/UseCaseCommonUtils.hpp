...
namespace app {
     ...
     * @param[in]       num_iterations   Number of iterations to conduct inference
     * @return          true if inference succeeds, false otherwise.
     **/
    bool RunInference(arm::app::Model& model, Profiler& profiler, const uint64_t &num_iterations);
