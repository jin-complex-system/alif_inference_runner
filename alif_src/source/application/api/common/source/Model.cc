...
bool arm::app::Model::EnlistOperations()
{
    tflite::MicroMutableOpResolver<this->kNumberOperators> mutableAllOpResolver;
   ...
   this->m_opResolver = mutableAllOpResolver;
   return true;
}

const tflite::MicroOpResolver& arm::app::Model::GetOpResolver()
{
